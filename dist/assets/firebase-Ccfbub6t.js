import{r as re,L as Sn,g as vt,i as Cn,a as Nn,_ as R,b as Me,C as xe,c as We,d as On,e as $e,f as Un,S as Q,h as N,E as je,j as Ln,k as Fe,l as ie,p as bt,m as At,n as E,F as ve,o as Dn,q as Mn,s as oe,t as xn,u as Fn,v as Vn,w as Bn,x as Hn,y as Wn,z as $n}from"./index.esm-CVpz-cIC.js";var jn="firebase",qn="12.15.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ae{constructor(e,t){this.shortDelay=e,this.longDelay=t,M(t>e,"Short delay should be less than long delay!"),this.isMobile=Cn()||Nn()}get(){return Jn()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function te(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function nr(n,e=!1){const t=N(n),r=await t.getIdToken(e),s=Ge(r);h(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:te(Oe(s.auth_time)),issuedAtTime:te(Oe(s.iat)),expirationTime:te(Oe(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Oe(n){return Number(n)*1e3}function Ge(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return ge("JWT malformed, contained fewer than 3 sections"),null;try{const s=Dn(t);return s?JSON.parse(s):(ge("Failed to decode base64 JWT payload"),null)}catch(s){return ge("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function st(n){const e=Ge(n);return h(e,"internal-error"),h(typeof e.exp<"u","internal-error"),h(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ar(n,e){const t=await Ot(n,{},async()=>{const r=oe({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,o=await Lt(n,s,"/v1/token",`key=${i}`),a=await n._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:r};return n.emulatorConfig&&ie(n.emulatorConfig.host)&&(c.credentials="include"),Nt.fetch()(o,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function cr(n,e){return Z(n,"POST","/v2/accounts:revokeToken",be(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sr(n,e,t=!1){if(R(n.app))return Promise.reject($(n));const r="signIn",s=await Jt(n,r,e),i=await j._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}function Cr(n,e,t,r){return N(n).onIdTokenChanged(e,t,r)}function Nr(n,e,t){return N(n).beforeAuthStateChanged(e,t)}const ke="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cs="__/auth/handler",Ns="emulator/auth/handler",Os=encodeURIComponent("fac");async function mt(n,e,t,r,s,i){h(n.config.authDomain,n,"auth-domain-config-required"),h(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Q,eventId:s};if(e instanceof Kt){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Fn(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[l,d]of Object.entries({}))o[l]=d}if(e instanceof ce){const l=e.getScopes().filter(d=>d!=="");l.length>0&&(o.scopes=l.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const l of Object.keys(a))a[l]===void 0&&delete a[l];const c=await n._getAppCheckToken(),u=c?`#${Os}=${encodeURIComponent(c)}`:"";return`${Us(n)}?${oe(a).slice(1)}${u}`}function Us({config:n}){return n.emulator?ze(n,Ns):`https://${n.authDomain}/${Cs}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rn="storage";function ao(n,e,t){return n=N(n),ji(n,e,t)}function co(n){return n=N(n),qi(n)}function uo(n,e){return n=N(n),Ji(n,e)}function Yi(n=$e(),e){n=N(n);const r=We(n,Rn).getImmediate({identifier:e}),s=Vn("storage");return s&&Qi(r,...s),r}function Qi(n,e,t,r={}){Xi(n,e,t,r)}function Zi(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new nt(t,r,s,e,Q)}function eo(){Me(new xe(Rn,Zi,"PUBLIC").setMultipleInstances(!0)),re(kt,Rt,""),re(kt,Rt,"esm2020")}eo();const to={apiKey:"AIzaSyBwLL99C2wpc7wzj6ANTt2UW6LUNr3Yhp4",authDomain:"saferides-73eb2.firebaseapp.com",projectId:"saferides-73eb2",storageBucket:"saferides-73eb2.firebasestorage.app"};let pe,vn,bn,An;try{pe=Hn().length?$e():Wn(to),vn=Ws(pe),bn=$n(pe),An=Yi(pe)}catch(n){console.error("Firebase failed to initialize. Verify the VITE_FIREBASE_* environment variables.",n)}const no=vn,ro=bn,so=An,lo=Object.freeze(Object.defineProperty({__proto__:null,auth:no,db:ro,storage:so},Symbol.toStringTag,{value:"Module"}));export{no as a,so as b,ro as d,lo as f,co as g,uo as r,oo as s,ao as u};
